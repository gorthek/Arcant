...
exports.default = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            const result = await LocalAIClient_1.localAI.generateResponseWithAction(question, systemContext, interaction.guildId || undefined, interaction.user.id);
            ...
            if (result.update?.triggerAction && interaction.guild) {
                ...
                if (result.update.triggerAction === 'lock_server') {
                    ...
                    await Server.findOneAndUpdate({ serverId: interaction.guildId }, { raidMode: true }, { upsert: true });
