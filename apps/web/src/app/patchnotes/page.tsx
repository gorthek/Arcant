...
import { CheckCircle2, Rocket, Wrench, Sparkles, AlertCircle, Settings2, Info, ChevronRight, Bot, X, Calendar, FileCode, Shield } from "lucide-react";
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center relative z-10">
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed text-lg mb-4">
                ...
                Cliquez sur n'importe quel patchnote ci-dessous pour l'ouvrir. Cliquez ensuite sur **chaque modification individuelle (commentaire)** pour inspecter les fichiers modifiés et le code source associé !
              </p>
            </div>
          </div>
        </motion.div>
                    ...
                    >
                      ...
                      <div className="space-y-3 relative z-10">
                        ...
                        {patch.changes.length > 3 && (
                          <div className="text-xs font-bold text-teal-400 hover:text-teal-300 transition-colors mt-2 pl-3 flex items-center gap-1">
                            Voir plus de détails ({patch.changes.length - 3}) <ChevronRight size={14} />
                          </div>
                        )}
                      </div>
