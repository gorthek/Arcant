...
export default function About() {
  return (
    <div className="min-h-screen bg-black text-white selection:bg-teal-500/30 font-sans overflow-x-hidden flex flex-col">
      <Navbar />
        ...
        <div className="my-24">
          ...
          <div className="flex justify-center">
              <motion.div 
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="group relative bg-[#050505] border border-white/10 rounded-2xl overflow-hidden hover:border-teal-500/50 transition-colors max-w-sm w-full"
              >
                <div className="aspect-square bg-[#0f0f0f] relative flex items-center justify-center">
                  <div className="w-24 h-24 rounded-full bg-gradient-to-br from-teal-500/20 to-emerald-500/20 border border-teal-500/30 flex items-center justify-center">
                    <span className="text-3xl text-teal-500 font-bold">G</span>
                  </div>
                </div>
                <div className="p-8 text-center">
                  <h3 className="text-2xl font-bold text-white">Gorthek</h3>
                  <p className="text-teal-400 font-medium mb-4">CEO & Fondateur</p>
