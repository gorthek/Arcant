    ...
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between bg-white/5 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl relative">
        <Link href="/">
          ...
          <motion.div 
            className="w-10 h-10 rounded-full overflow-hidden relative flex items-center justify-center bg-gradient-to-br from-teal-500/30 to-emerald-500/30 border border-teal-400/40 backdrop-blur-md shadow-[0_0_15px_rgba(20,184,166,0.3)]"
            whileHover={{ rotate: 360, boxShadow: "0 0 25px rgba(20,184,166,0.6)" }}
          ...
          >
            ...
            <svg viewBox="0 0 40 40" className="w-6 h-6 text-teal-300" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-emerald-400">
            Arcant
          </div>
          </motion.div>
        </Link>
        ...
        {isLoggedIn && user ? (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-teal-500/20 to-emerald-500/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300" />
          </motion.button>
        )}
      </div>
    </motion.nav>
